...
@section('title', 'Creación Tallas')

@section('content_header')
    <h1>Creación de Tallas</h1>
@stop
...
<div class="form-row">
  ...
  <div class="form-group col-md-6">
    ...
    <input type="text" class="form-control" id="size" name="size" value="{{old('size')}}" placeholder="Nombre de la Talla">
  </div>
  @error('size')
      <br>
