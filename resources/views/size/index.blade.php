...
@section('title', 'Registros de Tallas')
...
<?php //dd($registrosold);?>
@section('content')
<a href="size\create" class="btn btn-success">Crear Nuevo Talla</a><br><br>
        ...
        <tbody>
            ...
            @foreach($size as $reg)
                <tr>
                    ...
                    <td>{{ $reg->size }}</td>
                    <td>
                        <a href="size\edit\{{ $reg->id_size }}" class="btn btn-primary">
                            <span class="fas fa-fw fa-edit"></span>
                        </a>
                    </td>
                    <td>
                        <a href="size\confirmdestroy\{{ $reg->id_size }}" type="button" class="btn btn-danger">
