...
@csrf
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="product" name="product" value="{{ old('product') }}" placeholder="Nombres del Producto">
      @error('product')
        <br>
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="textarea" class="form-control" id="observations" name="observations" value="{{ old('observations') }}" placeholder="Observaciones">
      @error('observations')
        <br>
        <div class="alert alert-danger">{{ $message }}</div>
      @enderror
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="number" class="form-control" id="quantity" name="quantity"  value="{{old('quantity')}}" placeholder="Cantidad en Inventario">
      @error('quantity')
        <br>
        <div class="alert alert-danger">{{ $message }}</div>
      @enderror
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="date_shipment" name="date_shipment" value="{{old('date_shipment')}}" placeholder="Fecha de Embarque">
      @error('date_shipment')
        <br>
        <div class="alert alert-danger">{{ $message }}</div>
      @enderror
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
          ...
          $('#id_size').val(<?php echo old('id_size') ?>);
          $("#id_size").select2();
          $('#id_product_brand').val(<?php echo old('id_product_brand') ?>);
